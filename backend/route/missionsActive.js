...
const {getAllMissionsActives, getMissionsActivesByJoueur, getMissionsActivesNomsByJoueur, getMissionsActivesByStatus, getMissions24hByJoueur, updateStatutV, updatePhoto, updateStatutL, getMissionsActivesEnAttente} = require('../controllers/missionsActive')
...
router.get('/EnAttente', getMissionsActivesEnAttente)
