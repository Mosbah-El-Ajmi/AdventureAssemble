    ...
    <div className="Table">
      ...
      <table>
        <thead>
          <tr>
            <th>
              <button onClick={sortName}>Nom ↑</button>
            </th>
            <th>
              <button onClick={sortPoints}>Points ↑</button>
            </th>
            <th>
              <button onClick={sort24h}>Points 24H ↑</button>
            </th>
            <th>
              <button onClick={sortFinies}>Missions Finies ↑</button>
            </th>
            <th>
              <button onClick={sortLast}>Dernière Mission ↑</button>
            </th>
          </tr>
        </thead>
        <tbody id="content">
